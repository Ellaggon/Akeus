...
export const Description = () => {
  ...
  return (
    <section className="grid grid-cols-2 gap-9 max-w-5xl mx-auto my-24 p-8 rounded-2xl">
      <button onClick={handleClick} className={`bg-transparent border-none cursor-pointer ${hasBorder ? 'border-4 border-main-contrast' : ''}`}>
      ...
      <div className="flex flex-col justify-center">
        <h2 className="text-2xl font-semibold text-secondary mb-4">Bring the future today</h2>
