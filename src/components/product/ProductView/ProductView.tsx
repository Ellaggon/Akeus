...
import { SanitizeHTML } from "app/components/shared/SanitizaHTML";
  ...
  return (
    <main className="max-w-6xl md:mx-20 grid mt-20 md:grid-cols-2 gap-10">
      ...
      <section className="flex flex-col mx-3">
        ...
        <p className="border text-lg py-1 px-4 rounded-lg mb-3">
          {product ? product.tags : ""}
        </p>
        <SanitizeHTML tag="p">
          {product ? product.description : ""}
        </SanitizeHTML>
        <span className="text-secondary mt-3 text-2xl font-bold">
